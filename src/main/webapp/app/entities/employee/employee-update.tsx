  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterApp.employee.firstName')}
              ...
              <UncontrolledTooltip target="firstNameLabel">
                <Translate contentKey="jhipsterApp.employee.help.firstName" />
              </UncontrolledTooltip>
              <ValidatedField
                label={translate('jhipsterApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterApp.employee.email')}
                id="employee-email"
                name="email"
                data-cy="email"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterApp.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('jhipsterApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('jhipsterApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
