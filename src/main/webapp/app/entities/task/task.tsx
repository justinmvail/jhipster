      ...
      <h2 id="task-heading" data-cy="TaskHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="jhipsterApp.task.home.refreshListLabel">Refresh List</Translate>
          </Button>
        ...
        {taskList && taskList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="jhipsterApp.task.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="jhipsterApp.task.title">Title</Translate>
                </th>
                <th>
                  <Translate contentKey="jhipsterApp.task.description">Description</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterApp.task.home.notFound">No Tasks found</Translate>
            </div>
          )
        )}
      </div>
